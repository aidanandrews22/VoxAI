                ...
                <div className="backdrop-blur-md rounded-2xl overflow-hidden shadow-xl border border-adaptive ring-adaptive focus-within:ring-1 before:absolute before:inset-0 before:rounded-2xl before:shadow-[0_0_15px_rgba(0,0,0,0.05)] dark:before:shadow-[0_0_15px_rgba(255,255,255,0.03)]">
                  ...
                  <div className="flex items-center mx-auto px-4 py-4 justify-between">
                    <div className="space-x-2 flex items-center">
                      <button aria-disabled="false" aria-label="Upload files and more" className="flex items-center justify-center h-9 rounded-full border border-adaptive text-token-text-secondary w-9 hover:bg-token-main-surface-secondary dark:hover:bg-gray-700">
                      ...
                      <button className="flex h-9 min-w-8 items-center justify-center rounded-full border p-2 text-[13px] font-medium radix-state-open:bg-black/10 text-token-text-secondary border-adaptive focus-visible:outline-black can-hover:hover:bg-token-main-surface-secondary dark:focus-visible:outline-white dark:can-hover:hover:bg-gray-700" aria-pressed="false" aria-label="Search">
                      ...
                      <button type="button" id="radix-:rr1:" aria-haspopup="menu" aria-expanded="false" data-state="closed" className="_toolsButton_d2h2h_8 flex h-9 min-w-9 items-center justify-center rounded-full border border-adaptive p-1 text-xs font-semibold text-token-text-secondary focus-visible:outline-black disabled:opacity-30 radix-state-open:bg-black/10 can-hover:hover:bg-token-main-surface-secondary dark:focus-visible:outline-white dark:can-hover:hover:bg-gray-700" aria-label="Use a tool">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="pointer-events-none h-5 w-5">
